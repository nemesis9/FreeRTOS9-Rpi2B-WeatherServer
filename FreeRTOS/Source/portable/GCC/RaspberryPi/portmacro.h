...
typedef unsigned short portUSHORT;
//#define portSTACK_TYPE          unsigned portLONG
typedef unsigned long portSTACK_TYPE;
//#define StackType_t             unsigned portLONG
typedef unsigned long StackType_t;
//#define portBASE_TYPE           portLONG
typedef long portBASE_TYPE;
//#define BaseType_t              portLONG
typedef long BaseType_t;
//#define UBaseType_t             unsigned portLONG
...
#define GET_TIMER_COUNT()                       ulGetTimerCount()
#define DMEM_BAR                                __asm volatile { "DMB" };
#define DSYNC_BAR                               __asm volatile { "DSB" };
#define DINSTR_BAR                              __asm volatile { "ISB" };
/*-----------------------------------------------------------*/	
