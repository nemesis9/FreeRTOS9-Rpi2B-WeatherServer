...
static void prvSetupTimerInterrupt( void )
{
	...
	//pRegs->CTL = 0x003E00A2;
        // Also enable the free-running counter
	pRegs->CTL = 0x003E02A2;
...
/* TONY ADDITIONS */
// This is using the free running counter in the timer at portTIMER_BASE
// The APB bus clock is 250 MHz, so with a pre-divider of 0x3E + 1 = 0x3F
//     this gives us a free-running counter running @ ~4MHz 
// This should be good enough for bit-banging OneWire thru GPIO
UBaseType_t ulGetTimerCount( void )
{
    return pRegs->CNT;     
}
/*-----------------------------------------------------------*/
